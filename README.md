...
**FloodOps** is an automated machine learning pipeline designed to predict flood risks in the Chao Phraya Dam 7 days in advance. The system implements a complete **MLOps lifecycle**, featuring automated data ingestion, drift detection, self-healing retraining loops, and continuous deployment to a web frontend.
